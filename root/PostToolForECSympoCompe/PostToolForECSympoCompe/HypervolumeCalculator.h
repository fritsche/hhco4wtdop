...
namespace ECSC
{
	...
	private:
		...
		double hv_for_3solution_iea(SolutionSet& solutions, const Solution& ref_point, const int n_obj);
		double hv_for_4solution_iea(SolutionSet& solutions, const Solution& ref_point, const int n_obj);

		double hv_for_3solution(SolutionSet& solutions, const Solution& ref_point, const int n_obj);
		double hv_for_4solution(SolutionSet& solutions, const Solution& ref_point, const int n_obj);
