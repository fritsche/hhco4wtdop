 ...
 * @param <S>
 */
public class CMOEADDConstrainedDiversity<S extends Solution<?>> implements Algorithm<List<S>> {
    ...
    public CMOEADDConstrainedDiversity(CMOEADDConstrainedDiversityBuilder<S> builder) {
