 ...
 * @param <S>
 */
public class COCMOMBI2<S extends Solution<?>> extends CMOMBI2<S> implements CooperativeAlgorithm<S> {

    public List<S> offspringPopulation;

    public COCMOMBI2(Problem<S> problem, int maxIterations, CrossoverOperator<S> crossover, 
            MutationOperator<S> mutation, SelectionOperator<List<S>, S> selection, SolutionListEvaluator<S> evaluator, String pathWeights) {
