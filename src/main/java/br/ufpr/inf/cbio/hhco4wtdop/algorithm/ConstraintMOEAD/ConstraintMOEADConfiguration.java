 ...
 */
package br.ufpr.inf.cbio.hhco4wtdop.algorithm.ConstraintMOEAD;
 ...
 */
public class ConstraintMOEADConfiguration implements AlgorithmConfiguration<ConstraintMOEAD> {
    ...
    @Override
    public ConstraintMOEAD configure(int popSize, int maxFitnessEvaluations, Problem problem) {
        this.problem = (DoubleProblem) problem;

        setup();

        return (ConstraintMOEAD) new MOEADBuilder(problem, MOEADBuilder.Variant.ConstraintMOEAD)
