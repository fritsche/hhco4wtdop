 ...
 */
public class R2WithConstraintsFIR implements FitnessImprovementRateCalculator<Solution<?>> {
    ...
    public R2WithConstraintsFIR(Problem problem, int populationSize) {
    ...
    public double computeFitnessImprovementRate(List<Solution<?>> parents, List<Solution<?>> offspring) {
        ...
        double worsePossibleTchebycheff = 1.0;
        R2WithConstraints r2 = new R2WithConstraints(lambda, reference, new Tchebycheff(), worsePossibleTchebycheff);
        double parentR2 = r2.r2(parents);
        double offspringR2 = r2.r2(offspring);
